    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('whatsapp_name', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Where_to_Apply', models.CharField(default='Click Where you would like us to apply for you...', max_length=255)),
                ('image', models.ImageField(blank=True, default='/static/img/default-user.png', null=True, upload_to='carousel/%y/%m/%d/')),
                ('title', models.CharField(default='what are you seeking ?...', max_length=150)),
